  ...
  (
    ...
    return (
      <>
        <div
          ref={ref}
          className="group hidden text-foreground md:block"
          data-state={state}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "transition-opacity group-data-[state=expanded]:delay-200 group-data-[state=collapsed]:opacity-0",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-ring hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 active:bg-accent active:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-accent data-[active=true]:font-medium data-[active=true]:text-accent-foreground data-[state=open]:hover:bg-accent data-[state=open]:hover:text-accent-foreground group-data-[state=collapsed]:!justify-center group-data-[state=collapsed]:!size-10 group-data-[state=collapsed]:!p-2 [&>svg]:size-4 [&>svg]:shrink-0 [&>span]:truncate [&>span]:transition-opacity group-data-[state=expanded]:[&>span]:delay-200 group-data-[state=collapsed]:[&>span]:opacity-0",
  {
    variants: {
      variant: {
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-foreground outline-none ring-ring transition-transform hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 group-hover/menu-button:text-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 after:md:hidden",
        ...
        "transition-opacity group-data-[state=expanded]:delay-200 group-data-[state=collapsed]:opacity-0 group-data-[state=collapsed]:pointer-events-none",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 group-data-[active=true]/menu-button:text-accent-foreground md:opacity-0",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "group-hover/menu-button:text-accent-foreground group-data-[active=true]/menu-button:text-accent-foreground",
      "group-data-[size=sm]/menu-button:top-1",
      "group-data-[size=default]/menu-button:top-1.5",
      "group-data-[size=lg]/menu-button:top-2.5",
      "transition-opacity group-data-[state=expanded]:delay-200 group-data-[state=collapsed]:opacity-0 group-data-[state=collapsed]:pointer-events-none",
